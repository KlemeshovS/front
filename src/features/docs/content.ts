...
const sRequestHeaders: DocsSection = {
  id: "request-headers",
...
const sMaintenance: DocsSection = {
  id: "maintenance",
...
const sAuthAnonymous: DocsSection = {
  id: "auth-anonymous",
...
const sAuthApple: DocsSection = {
  id: "auth-apple",
  title: "POST /auth/apple",
  cards: [
    {
      method: "POST",
      badgeClass: "post",
...
const sAuthYandex: DocsSection = {
  id: "auth-yandex",
  title: "POST /auth/yandex",
  cards: [
    {
      method: "POST",
      badgeClass: "post",
...
const sAuthSession: DocsSection = {
  id: "auth-session",
...
const sAuthRefresh: DocsSection = {
  id: "auth-refresh",
...
const sAuthProviders: DocsSection = {
  id: "auth-providers",
...
const sAuthProvidersLink: DocsSection = {
  id: "auth-providers-link",
  title: "POST /auth/providers/{p}/link",
  cards: [
    {
      method: "POST",
      badgeClass: "post",
...
const sAuthProvidersUnlink: DocsSection = {
  id: "auth-providers-unlink",
  title: "DELETE /auth/providers/{provider}",
  cards: [
    {
      method: "DELETE",
      badgeClass: "delete",
...
const sAvatarUpload: DocsSection = {
  id: "avatar-upload",
  title: "POST /me/avatar",
  cards: [
    {
      method: "POST",
      badgeClass: "post",
...
const sAvatarDelete: DocsSection = {
  id: "avatar-delete",
  title: "DELETE /me/avatar",
  cards: [
    {
      method: "DELETE",
      badgeClass: "delete",
...
const sAccountDelete: DocsSection = {
  id: "account-delete",
  title: "DELETE /me",
  cards: [
    {
...
const sLeaderboard: DocsSection = {
  id: "leaderboard",
  title: "Leaderboard",
  cards: [
    {
...
export const docsPages: DocsPage[] = [
  ...
  },
  {
    id: "leaderboard",
    title: "Leaderboard",
    sections: [sLeaderboard],
  },
  {
    id: "service",
    title: "Service",
    sections: [sHealth, sAdminApi],
  },
];
